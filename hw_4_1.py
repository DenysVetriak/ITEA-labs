...
def text_stat(text):
    # Разбиваем пользовательский ввод на символы
    one_symbol = list(''.join(text))

    # Сколько элементов в изначальном списке столько и было введено строк
    print("Всего строк = {}".format(len(text)))
    # Считаем сколько символов в введенных пользователем строках
    count_numbers(one_symbol)

    # Строим и выводим словарь символов в строках
    count_symbols(one_symbol)

    # Строим и выводим словарь слов в строках
    count_word(text)
